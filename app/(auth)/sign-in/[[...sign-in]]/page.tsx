  ...
  return (
    <>
      ...
      <div className='absolute top-0 bg-red-500 min-w-full'>
        ...
        <div className='flex flex-col border-2 rounded-xl px-4 py-8 border-blue-500 justify-center items-center  gap-5'>
          <div>
          ...
          <form onSubmit={submit} className='flex flex-col gap-5' >
            ...
            <button onClick={() => signUpWith('oauth_google')} className='bg-blue-600 flex gap-2 items-center text-center justify-center px-4 py-2 rounded-xl '>
