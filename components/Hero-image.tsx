...
export default function HeroImage() {
  ...
  if (!mounted) {
    return <div className="w-full h-[400px] bg-gray-100 rounded-lg animate-pulse"></div>
  }
              ...
              <div className="bg-gray-100 dark:bg-gray-700 rounded-lg h-20 w-full overflow-hidden relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <div className="text-xs text-gray-500 dark:text-gray-300">Per Compression</div>
                  </div>
                </div>
              </div>
            </div>
