          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex flex-col gap-4">
              <div
                ...
                className="bg-gray-100 rounded-lg h-40 w-full overflow-hidden relative"
              >
              ...
              <div className="bg-gray-100 rounded-lg h-20 w-full overflow-hidden relative">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    <div className="text-primary font-bold">1 Credit</div>
                    <div className="text-xs text-gray-500">Per Compression</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="bg-gray-100 rounded-lg h-20 w-full overflow-hidden grid grid-cols-3 gap-2 ">
                <div className="bg-white rounded shadow-sm  flex flex-col items-center justify-center">
